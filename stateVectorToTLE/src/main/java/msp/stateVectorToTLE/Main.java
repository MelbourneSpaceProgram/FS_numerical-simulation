 ...
 * Code for fitting the TLE to the propagated state is
...
public class Main {
	...
	public static void main(String[] args) {
      ...
      try {
          ...
          final Vector3D initialPositionItrf = new Vector3D(5151.1899e3, -1976.6508e3, 4022.4817e3); // m
          ...
          final PVCoordinates initialStateItrf = new PVCoordinates(initialPositionItrf, initialVelocityItrf);
          final Transform itrfToTeme =
              FramesFactory.getITRF(IERSConventions.IERS_2010, false).getTransformTo(
                  FramesFactory.getTEME(), launchDate);
          ...
          final CartesianOrbit initialOrbit = new CartesianOrbit(initialStateTeme, FramesFactory.getTEME(), launchDate, muEarth);
          ...
          final double[][] tolerance = NumericalPropagator.tolerances(dP, initialOrbit, OrbitType.CARTESIAN);
